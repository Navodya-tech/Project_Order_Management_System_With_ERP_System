...
-- Dumping data for table order_management_system_with_erp_db.company_expences: ~0 rows (approximately)
...
-- Dumping data for table order_management_system_with_erp_db.company_promotion: ~0 rows (approximately)
...
-- Dumping data for table order_management_system_with_erp_db.invoice: ~2 rows (approximately)
...
-- Dumping data for table order_management_system_with_erp_db.invoice_items: ~4 rows (approximately)
...
-- Dumping data for table order_management_system_with_erp_db.leave: ~1 rows (approximately)
...
-- Dumping data for table order_management_system_with_erp_db.order_details: ~2 rows (approximately)
...
-- Dumping data for table order_management_system_with_erp_db.order_items: ~4 rows (approximately)
